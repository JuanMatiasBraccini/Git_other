...
Tagging=Tagging%>%
  mutate(CAPTVESS=tolower(CAPTVESS),
         ...
         CAPTVESS=case_when(CAPTVESS%in%c("rvnaturaliste","nat") ~'naturaliste',
                            ...
                            grepl(tolower('Beveridge'),tolower(CAPTOR)) ~"f070",
                            grepl(tolower('parkinson'),tolower(CAPTOR)) ~"e063",
                            grepl(tolower('wassman'),tolower(CAPTOR)) ~"f520",
                            ...
                            grepl(tolower('whtstone'),tolower(CAPTOR)) ~"e034",
                            grepl(tolower('gibellini'),tolower(CAPTOR)) ~"b040",
                            grepl(tolower('j. king'),tolower(CAPTOR))  ~"b028",
                            grepl(tolower('G.KENNEDY'),tolower(CAPTOR)) & DATE_CAPTR<as.POSIXct("30/05/1996", format = "%d/%m/%Y")~"a278",
                            grepl(tolower('G.KENNEDY'),tolower(CAPTOR)) & DATE_CAPTR>as.POSIXct("30/05/1996", format = "%d/%m/%Y") ~"a161",
                            grepl(tolower('leggerini'),tolower(CAPTOR)) ~"a271",
                            grepl(tolower('merinda pearl'),tolower(CAPTOR)) ~"f317",
                            #grepl(tolower('MARKELLOS'),tolower(CAPTOR)) ~"",   #Mark/Sarah could not id these ones
